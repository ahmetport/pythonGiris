...
mesaj["From"] = "umitenes89@gmail.com"  # Kimden Göndereceğimiz

mesaj["To"] = "umitenes89@gmail.com"  # Kime Göndereceğimiz
...
try:
    ...
    mail.login("umitenes89@gmail.com",
               "Ahmet2727*")  # SMTP server'ına giriş yapıyoruz. Kendi mail adresimizi ve parolamızı yapıyoruz.
